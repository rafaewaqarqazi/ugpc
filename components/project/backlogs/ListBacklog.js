    ...
    <div>
                  ...
                  <div key={column.id}>
                    <div className={classes.actions}>
                      ...
                      <Typography variant='caption' color='textSecondary'
                                  className={classes.title}>{`${column.tasksIds.length} tasks`}</Typography>
                      {
                ...
                <div className={classes.detailsContainer}>
                  <div className={classes.detailsHeader}>
                    ...
                    <Tooltip title='Remove Task' placement="top" TransitionComponent={Zoom}>
                      <div>
                        <IconButton size='small' disabled={details.createdBy.role !== userContext.user.user.role}
                                    onClick={() => setRemoveTaskDialog(true)}>
                          <Delete
                            color={(details.createdBy.role === userContext.user.user.role) ? 'error' : 'disabled'}/>
                        </IconButton>
                      </div>
                    </Tooltip>
          ...
          <DialogContent dividers>
            ...
            <div>
              ...
              <Typography component='span'
                          variant='subtitle1'>{`SPR-${projectContext.project.project.details.sprint.length + 1}`}</Typography>
            </div>
            {
              planSprintError &&
              <Typography
...

      {
        ...
        <Dialog open={lessWeekConfirmation} onClose={() => setLessWeekConfirmation(false)} fullWidth maxWidth='xs'
          ...
          <DialogContent dividers>
            <DialogContentText>Tasks in sprint require less time than specified weeks, do you want to
              continue?</DialogContentText>
          </DialogContent>
          <DialogActions>
