          ...
          if (!project.isLoading) {
            return (
              <Container className={classes.footerMargin}>
                ...
                <Typography variant='subtitle1' className={progressClasses.title}
                      ...
                      <div className={progressClasses.top}>
                        ...
                        <div className={progressClasses.containerContent}>
                          ...
                          <Typography variant='h5'
                                      color='textSecondary'>{`${getCompletionPercentage(project.project.details)}%`}</Typography>
                          <LinearProgress className={progressClasses.progressBar} variant='determinate'
                                          value={getCompletionPercentage(project.project.details)}/>
                    ...
                    <div className={progressClasses.container}>
                      <div className={progressClasses.top}>
                        ...
                        <div className={progressClasses.containerContent}>
                          ...
                          <Typography variant='h5'
                                      color='textSecondary'>{`${getSprintsPercentage(project.project.details)}%`}</Typography>
                          <LinearProgress className={progressClasses.progressBar} variant='determinate'
                                          value={getSprintsPercentage(project.project.details)}/>
                    ...
                    <div className={progressClasses.container}>
                      <div className={progressClasses.top}>
                        ...
                        <div className={progressClasses.containerContent}>
                          <Typography variant='body2' color='textSecondary'>Sprints</Typography>
                          <Typography variant='h5'
                                      color='textSecondary'>{project.project.details.sprint.length}</Typography>
                        </div>
                      </div>
                      <Divider/>
                      <div className={progressClasses.topProgressBarContainer}>
                                ...
                                project.project.details.sprint.length === 0 ?
                                  ...
                                  project.project.details.sprint.map((sprint, index) => (
                                    <TableRow key={index} className={tableClasses.tableRow}
                                              style={getSprintTableRowBorder(sprint)}>
