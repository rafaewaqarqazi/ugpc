                    ...
                    <TableCell>
                      <Tooltip title='Click to View/Download Document' placement="top" TransitionComponent={Zoom}>
                        <a style={{textDecoration: 'none', color: 'grey'}}
                           href={`${serverUrl}/../pdf/${doc.document.filename}`} target="_blank">
                    ...
                    <TableCell>
                      {
                        doc.status === 'Completed' ?
                          <Chip label={getGrade(projectContext.project.project.details.marks)}
                                style={getGradeChipColor(getGrade(projectContext.project.project.details.marks))}/> : 'Not Specified Yet'
                      }
                    </TableCell>
