    ...
    <Page size="A4" style={styles.body}>
      ...
      <View>
        <Text style={{textIndent: 50}}> The Department has allocated project titled above to
          ...
          <Text> Department of Computer Science & Software Engineering, Faculty of Basic & Applied Sciences,
            ...
            <Text style={{fontFamily: 'Times-Italic'}}> If the project is not completed within
              prescribed period, then you have to re-register in the next semester with only registration fee. Students
              failing to
              complete project even in the additional duration will have to pay full fee for subsequent semester that
              will include
        ...
        <Text style={{textIndent: 50}}>
          Weekly progress report duly signed by the supervisor must also be submitted to the Program Coordinator.
          Project presentation
          within the concerned SIG after every three weeks is mandatory. Project will be evaluated as per the following
          criteria
        </Text>
      </View>
      ...
      <View>
        <Text style={{textIndent: 50}}>The student must submit the copies of the project report within three months
          after the Viva Voce exam;
      ...
      <Text style={styles.footer} fixed>Science Block, Sector H-10, Islamabad. Phone +92 51 9257951 Email:
        HDCS@iiu.edu.pk</Text>
