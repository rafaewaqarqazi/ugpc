  ...
  const drawerContent = (
    <Fragment>
      <List>
        ...
        <DrawerLink href='/supervisor/project/[projectId]/scrumBoard'
                    as={`/supervisor/project/${projectId}/scrumBoard`}>
          <ListItemIcon>
    ...
    <div className={classes.toolbar}>
      <FormControl variant="outlined" margin='dense' style={{flexGrow: 1}}>
        ...
        <Select
          ...
          input={<OutlinedInput classes={switchClasses} labelWidth={100} fullWidth name="projectSwitch"
                                id="projectSwitch" required/>}
        >
