    ...
    userContext.user.isLoading ? <div style={{flexGrow: 1}}/> : userContext.user.user.role === 'Supervisor' ?
      <FormControl variant="outlined" margin='dense'>
        ...
        <Select
          ...
          input={<OutlinedInput classes={switchClasses} labelWidth={67} fullWidth name="accountSwitch"
                                id="accountSwitch" required/>}
        >
          <MenuItem value={userContext.user.user.ugpc_details.position} style={{fontSize: 14}}>Coordinator
            View</MenuItem>
