...
export const assignSupervisorAutoAPI = async (projectId, title, regNo) => {
  const res = await fetch(`${serverUrl}/projects/supervisor/assign/auto`, {
    method: 'PUT',
    headers: {
...
export const assignSupervisorManualAPI = async (data) => {
  const res = await fetch(`${serverUrl}/projects/supervisor/assign/manual`, {
    method: 'PUT',
    headers: {
      Accept: 'application/json',
      "Content-Type": 'application/json',
