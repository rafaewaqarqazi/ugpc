                ...
                <div className={classes.listContainer}>
                    <div className={classes.top}>
                        ...
                        <div className={classes.topTitle} >
                            <Typography variant='h5'>Internal/External Letters</Typography>
                        </div>
                    </div>
                        ...
                        <div className={classes.listHeader}>
                            <FormControl variant="outlined" margin='dense' style={{minWidth:160}}>
                                ...
                                <Select
                                    ...
                                    input={<OutlinedInput fullWidth labelWidth={87} name="department" id="department" />}
                                >
...
export default withChairmanOfficeAuthSync(InternalExternal);