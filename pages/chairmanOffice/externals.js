                                    ...
                                    <TableBody>

                                        {
                                            ...
                                            filter.map((project,index) => (
                                                <Tooltip key={index} title='Click to view Details' placement="top-start" TransitionComponent={Zoom} onClick={()=>handleDetails(project)}>
                                            ...
                                            <Container>
                                                {
                                                    details.details.external.examiner ?
                                                        ...
                                                        <div>
                                                            ...
                                                            <Button variant='outlined' size='small' color='primary' onClick={()=>setDialog({...dialog,externalAssign: true})}>Assign Now</Button>
                                                        </div>
            ...
            <Dialog open={dialog.externalAssign} onClose={()=>setDialog({...dialog,externalAssign: false})} fullWidth maxWidth='sm'>
                ...
                <DialogContent dividers>
                    <FormControl component="fieldset">
                        ...
                        <FormControlLabel
                            control={<Switch checked={autoAssignExternal} onChange={handleExternalSwitch} value={autoAssignExternal ? 'Yes' : 'No'} />}
