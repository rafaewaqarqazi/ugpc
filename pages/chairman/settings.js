...
const Settings = () => {
    ...
    return (
        <ChairmanPanelLayout>
            ...
            <ErrorSnackBar open={errorMess.open} message={errorMess.message} handleSnackBar={()=>setErrorMess({open:false,message:''})}/>
            <Container>
                <div className={classes.listContainer}>
                    ...
                    <div className={settingsClasses.root}>
                        ...
                        <ExpansionPanel expanded={expanded === 'batchPanel'} className={settingsClasses.expansionPanel} onChange={handleChange('batchPanel')}>
                            <ExpansionPanelSummary
                                expandIcon={<ExpandMore />}
                                        ...
                                        userContext.user.isLoading ? <CircularLoading/> :
                                            <div>
                                                <div style={{display:'flex',flexDirection:'row',justifyContent:'flex-end'}}>
                                                    <Button color='primary' startIcon={<Add/>} onClick={()=>setNewBatchDialog(true)}>Add New</Button>
                                                </div>
                                                {
                                                                    ...
                                                                    <ListItem key={index} className={settingsClasses.batchListItem}>
                                                                        ...
                                                                        <ListItemSecondaryAction>
                                                                            <Tooltip  title='Remove Batch' placement="top" TransitionComponent={Zoom}>
                                                                                <IconButton edge="end" aria-label="delete" onClick={()=>handleClickRemoveBatch(batch)}>
                                                                                    <Delete />
                                                                                </IconButton>
                                                                            </Tooltip>
                                                                        </ListItemSecondaryAction>
